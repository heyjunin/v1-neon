...
import {
  createUser,
  updateUser,
} from "../packages/database/src/mutations/index.js";
...
async function testUserSync() {
  try {
    ...
    if (existingUser) {
      console.log(
        `✅ Usuário encontrado: ${existingUser.fullName} (${existingUser.email})`,
      );
    } else {
    ...
    try {
      ...
      console.log(
        `✅ Usuário criado: ${createdUser.fullName} (${createdUser.email})`,
      );
    } catch (error) {
