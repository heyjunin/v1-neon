...
export const organizationMembers = pgTable(
  ...
  (table) => ({
    orgUserIdx: index("idx_org_members_org_user").on(
      table.organizationId,
      table.userId,
    ),
    userIdIdx: index("idx_org_members_user_id").on(table.userId),
    organizationIdIdx: index("idx_org_members_organization_id").on(
      table.organizationId,
    ),
  }),
);
...
export const organizationInvites = pgTable(
  ...
  (table) => ({
    ...
    organizationIdIdx: index("idx_org_invites_organization_id").on(
      table.organizationId,
    ),
  }),
);
